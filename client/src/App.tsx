      ...
      {!showMainContent && (
        ...
        >
          <div ref={introRef}>
            <h1
              ref={introTextRef}
              className="text-3xl md:text-3xl lg:text-5xl xl:text-5xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent"
            >
