...
export default function WorkExperience() {
    ...
    useGSAP(() => {
        ...
        gsap.set([titleRef.current, circleRef.current, lineRef.current], { 
            opacity: 0 
        });
        ...
        // 2. SINGLE Timeline for header and line elements
        // FIXED: One timeline handling all initial animations
        const headerTl = gsap.timeline({
            scrollTrigger: {
                trigger: sectionRef.current,
                start: "top 50%",
                end: "top 0%",  // Added end point
        ...
        experienceRefs.current.forEach((el) => {
            ...
            const itemTl = gsap.timeline({
                scrollTrigger: {
                    trigger: el,
                    start: "top 65%",  // Adjusted trigger point
                    end: "bottom 35%",  // Added end point for better reverse behavior
                    toggleActions: "play none none reverse",
                }
            });
