    ...
    return (
        <section ref={sectionRef} id="about" className="overflow-hidden">
            <h1
                ...
                className='text-2xl md:text-2xl lg:text-3xl xl:text-3xl flex justify-center mt-20 md:mt-30 lg:mt-4 xl:mt-25'
                ref={aboutheaderRef}
            >
                About Me
            </h1>
            ...
            <div className='flex justify-between grid grid-cols-1 xl:grid-cols-12'>
                ...
                <div className='items-center my-10 mx-5 xl:col-start-8 xl:col-span-5 xl:mt-20'>
                    <div ref={headerRef}>
                        <h1
